import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3d7dc540.js";const F=JSON.parse('{"title":"Nextcloud","description":"","frontmatter":{"title":"Nextcloud","lang":"es-ES"},"headers":[],"relativePath":"servicios/nextcloud.md","filePath":"servicios/nextcloud.md","lastUpdated":1706267737000}'),p={name:"servicios/nextcloud.md"},o=l(`<h1 id="nextcloud-almacenamiento" tabindex="-1">Nextcloud - Almacenamiento <a class="header-anchor" href="#nextcloud-almacenamiento" aria-label="Permalink to &quot;Nextcloud - Almacenamiento&quot;">​</a></h1><p>Por fin llegó el momento de poner en marcha el primer servicio, y qué mejor elección que <a href="https://nextcloud.com/es/" target="_blank" rel="noreferrer">Nextcloud</a>. Antes de empezar asegúrate de que tienes un subdominio creado para Nextcloud como <code>cloud.wupp.dev</code>.</p><h2 id="configurando-docker" tabindex="-1">Configurando Docker <a class="header-anchor" href="#configurando-docker" aria-label="Permalink to &quot;Configurando Docker&quot;">​</a></h2><p>Empezamos escribiendo en el <code>docker-compose.yml</code> todo lo necesario para tener una instalación funcional de Nextcloud:</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#85E89D;">services</span><span style="color:#E1E4E8;">:</span></span>
